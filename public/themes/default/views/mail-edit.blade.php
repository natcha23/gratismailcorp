...
@section('content')
  ...
  <article id="mail">
    <h2 class="header"><i class="fa fa-edit" style="color: #AAA"></i> {{ $title }}</h2>
    {{ Form::open(['url' => 'compose/new', 'class' => 'form-inline disable-enter', 'id' => 'send-compose']) }}
      ...
      <div class="form-group" style="width:100%; margin-bottom: 5px;">
        ...
        {{ Form::text('txtSubject', $mail->subject, ['class' => 'form-control input-sm', 'style' => 'display:block; width:100%; border-color: #DDD']) }}
      </div>
      <div class="form-group" style="width:100%; margin-bottom: 5px;">
        <textarea id="txtDetail" name="txtDetail">{{ $mail->text }}</textarea>
      </div>
      <div class="form-group" style="width:100%; margin-bottom: 5px;">
        {{ Form::label('txtPicture', 'File attachment', array()) }}
        <div class="dropzone">
