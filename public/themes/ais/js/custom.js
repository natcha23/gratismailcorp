$(function(){
  ...
  if($("a.btn-return")){
    $("a.btn-return").on('click', function(event){
    	var a_href = $(this).attr('href');
    	event.preventDefault();
        $parant = $(this).parent().parent();
      $message = $(this).data('message');
      if($message == undefined || $message == "") {
    	  $message = "Do you want to cancel on your doing?";
      }
      // ================
      $("#discardModal").modal("toggle").on("shown.bs.modal", function (e) {
        ...
        $(this).find('.modal-footer #btnDiscard').focus().data('form', form);
      });

  	    /* Form confirm (yes/ok) handler, submits form */
  	    $('#discardModal').find('.modal-footer #btnDiscard').on('click', function(){
  ...
  $("a.submit").on('click', function(){
	 ...
	 // ================
	    $("#confirmModal").modal("toggle").on("shown.bs.modal", function (e) {
	      ...
	      /* Pass form reference to modal for submission on yes/ok */
	      var form = $(e.relatedTarget).closest('form');
	      $(this).find('.modal-footer #btnSubmit').focus().data('form', form);
	    });
