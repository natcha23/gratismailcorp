...
require("/var/www/html/SMMGetInfo/gratismailcorp/public/libraries/PHPMailer/PHPMailerAutoload.php");

echo "<pre>Start test Send Mail [".date('Y-m-d H:i:s')."].</pre>";

//$EMAIL_SENDER = "1149test1@ais.co.th";
//$SENT_PWD = "3UPN4r@5Yb#e";

$EMAIL_SENDER = "1149test3@ais.co.th";
$SENT_PWD = "D!XyV#2g3$$bD";

$CURR_TIME  = date('Y-m-d H:i:s');
$CURR_TIME2 = " (" . date('d/m H:i') . ")";

$EMAIL_ADDR = "1149test1@ais.co.th";
$EMAIL_SUBJECT = "[SMM Corp] Test Email ".$CURR_TIME2;
$EMAIL_MSG = "test msg - ข้อความทดสอบ [".$CURR_TIME."]. ";
...
print "<pre>Preparing Email ... </pre>"; 
	...
	$mail->Password = $SENT_PWD;
	$mail->Encoding = "base64";
	$mail->CharSet= "UTF-8";
	$mail->From = $EMAIL_SENDER;
	$mail->FromName = "AIS 1149 Test 3";
	$mail->WordWrap = 50;

//	$mail->AddAddress('1149test1@ais.co.th');
//	$mail->addCC('1149test3@ais.co.th');
