...
//      $mail = GMMail::orderBy('mail_id', 'desc')->first();
//      $mail_id = ($mail->mail_id + 1);
...
//        $mail->AddAttachment("public/attachments/{$file->file_name}", $file->file_name_original);
        $mail->AddAttachment("public/attachments/".date('Ymd')."/{$file->file_name}", $file->file_name_original);
      endforeach;
    endif;
    $mail->IsHTML(true);
